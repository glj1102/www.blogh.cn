...
// if you want to load `layout.txt` as the default layout
...
app.get('/with-layout',function(req,res,next){
  res.render('with-layout.txt');
})

app.get('/with-layout-override',function(req,res,next){
  res.render('with-layout.txt',{_layoutFile:false})
})
...
app.get('/subfolder/subitem-with-layout',function(req,res,next){
  res.render('subfolder/subitem-with-layout.txt');
});
...
describe('app',function(){
  ...
  describe('GET /',function(){
    it('should render with default layout.txt',function(done){
      request(app)
        .get('/')
        .end(function(res){
  ...
  describe('GET /collection/_entry',function(){
    it('should render _entry.ejs for every item with layout.txt as layout',function(done){
      request(app)
  ...
  describe('GET /collection/thing-path',function(){
    it('should render thing/index.ejs for every item with layout.txt as layout',function(done){
      request(app)
  ...
  describe('GET /with-layout',function(){
    it('should use layout.txt when rendering with-layout.txt',function(done){
      request(app)
        .get('/with-layout')
        .end(function(res){
          res.should.have.status(200);
  ...
  describe('GET /with-layout-override',function(){
    it('should use layout.txt when rendering with-layout.txt, even if layout=false in options',function(done){
      request(app)
  ...
  describe('GET /subfolder/subitem',function(){
    it('should render subfolder/subitem.ejs and still use layout.txt',function(done){
      request(app)
  ...
  describe('GET /subfolder/subitem-with-layout',function(){
    it('should render subitem-with-layout.txt using sub-layout.txt',function(done){
      request(app)
