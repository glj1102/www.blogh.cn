...
FCKConfig.ToolbarSets["Default"] = [
	...
	['Link','Unlink','Anchor'],
	['Image','Flash','MadMedia','Table','Rule','Smiley','SpecialChar','PageBreak','UniversalKey'],
	'/',
...
FCKConfig.FlashUploadAllowedExtensions	= ".(swf|fla|mp3|wmv|avi|wma|rm|rmvb|mp4|ram|rar|zip|doc|txt)$" ;		// empty for all
...
FCKConfig.Plugins.Add( 'madmedia', 'en,zh-cn' ) ;
//FCKConfig.Plugins.Add( 'fileupload', 'en,zh-cn' ) ;